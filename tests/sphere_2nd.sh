...
prefixes=(divu mask p ux uy uz vorx vory vorz)
# list of possible times (no need to actually have them)
times=(000000 000200 000400 000500)

# run actual test
${mpi_command} ./mistral ${params}
echo "============================"
