...
module insect_module
  ...
  ! Maximum number of Hermite interpolation nodes (hardcoded because of sxf90
...
contains
  ...
  subroutine Draw_Insect ( time, Insect, mask, mask_color, us)
    ...
    if ((mpirank==0).and.((iMoving.ne.1).or.(iPenalization.ne.1))) then
      ...
      call abort("insects.f90::DrawInsect: the parameters iMoving or iPenalization are wrong.")
    endif
