...
subroutine cal_nlk(time,u,nlk,work,mask,mask_color,us,Insect)
    use p3dfft_wrapper
    use basic_operators
    use insect_module
    use vars
    ...
    case("centered_2nd")
        if (nx==1) then
            call rhs_acm_2nd_2D(time,u,nlk,work,mask,mask_color,us,Insect,0)
        else
            call rhs_acm_2nd(time,u,nlk,work,mask,mask_color,us,Insect,0)
        endif
    case("centered_4th")
        if (nx==1) then
            call rhs_acm_4th_2D(time,u,nlk,work,mask,mask_color,us,Insect,0)
        else
            call rhs_acm_4th(time,u,nlk,work,mask,mask_color,us,Insect,0)
        endif
    end select
...
!-------------------------------------------------------------------------------
subroutine rhs_acm_2nd(time,u,nlk,work,mask,mask_color,us,Insect,impmode)
    use vars
    use insect_module
    use basic_operators
    use ghosts
...
!       nlk: the right hand side vector
!-------------------------------------------------------------------------------
subroutine rhs_acm_4th(time,u,nlk,work,mask,mask_color,us,Insect,impmode)
    use vars
    use insect_module
    use ghosts
...
!       nlk: the right hand side vector
!-------------------------------------------------------------------------------
subroutine rhs_acm_2nd_2D(time,u,nlk,work,mask,mask_color,us,Insect,impmode)
    use vars
    use insect_module
    use basic_operators
    use ghosts
...
!       nlk: the right hand side vector
!-------------------------------------------------------------------------------
subroutine rhs_acm_4th_2d(time,u,nlk,work,mask,mask_color,us,Insect,impmode)
    use vars
    use insect_module
    use ghosts
